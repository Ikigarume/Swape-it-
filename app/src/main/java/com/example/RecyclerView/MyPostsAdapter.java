...
public class MyPostsAdapter extends RecyclerView.Adapter<MyPostsAdapter.MyViewHolder> {
    ...
    public MyPostsAdapter(Context context, ArrayList<Annonce> Annonces){
        ...
        public MyViewHolder(final View itemView) {
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    builder.setMessage("Do you wish to edit your post ?");
                    builder.setTitle("Editing Post");
                    builder.setCancelable(false);
                    builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
                        Intent intent = new Intent(context, NewPost_Activity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
