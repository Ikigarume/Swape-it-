...
public class MapsActivity_NewPost extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mapFragment.getMapAsync(MapsActivity_NewPost.this);
                }
            }
        });
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(@NonNull LatLng arg0) {
                ...
                //Toast.makeText(MapsActivity_NewPost.this, "" + arg0, Toast.LENGTH_SHORT).show();
                SharedPreferences pref = getApplicationContext().getSharedPreferences("Login", 0);
                SharedPreferences.Editor editor = pref.edit();
                Intent intent = new Intent(MapsActivity_NewPost.this, NewPost_Activity.class);
